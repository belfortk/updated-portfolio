export default function projects() {
  return [
    ...
    },
    {
      ...
      summary:
      "I was the team lead in creating a full stack scalable GrubHub clone product with authentication. This was my first time working with a group to produce an Minimum Viable Project for a product owner and my introduction to the software development cycle. As part of an Agile team, I led the daily SCRUM, the creation of user stories, and assignment of tickets. In this project we implemented a RESTful MongoDb backend with Loopack. In the front end, we integrated Google Places and Stripe to handle location and checkout services. I was also responsible in the user sign-up and customer shopping experience. The biggest challenge we faced was getting our Git workflow down and effectively collaborating on the different aspects of the project.",      heroImg: "/images/MealHouse/HERO.png",
